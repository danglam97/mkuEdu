...
class WebLinkPolicy
{
    ...
    {
        return $user->can('view_any_web::link');
    }
    ...
    {
        return $user->can('create_web::link');
    }
    ...
    {
        return $user->can('update_web::link');
    }
    ...
    {
        return $user->can('delete_web::link');
    }
    ...
    {
        return $user->can('delete_any_web::link');
    }
