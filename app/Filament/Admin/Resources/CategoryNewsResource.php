...
use App\Filament\Admin\Resources\CategoryNewsResource\Pages;
use App\Filament\Admin\Resources\CategoryNewsResource\RelationManagers;
...
class CategoryNewsResource extends Resource implements HasShieldPermissions
{
                                    ...
                                    ->schema([
                                        Forms\Components\TextInput::make('name')
                                            ...
                                            ->rules([
                                                ...
                                                'max:255',
                                                fn($record) => $record
                                                    ? "unique:category_news,name,{$record->id}"
                                ...
                                Forms\Components\Grid::make(2)
                                    ->schema([
                                        ...
                                        Forms\Components\Select::make('id_parent')
                                            ->label('Danh mục cha')
                                            ->options(\App\Models\CategoryNews::groupedCategories())
                                            ->searchable()
                                            ->preload()
